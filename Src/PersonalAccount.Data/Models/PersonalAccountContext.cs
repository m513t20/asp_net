...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("affiliates_pkey");
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.Affiliates)
                .HasForeignKey(d => d.CompanyId)
                .HasConstraintName("affiliates_company_id_fk");
        });
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasOne(d => d.Affiliate).WithMany(p => p.Categories)
                .HasForeignKey(d => d.AffiliateId)
                .HasConstraintName("categories_affiliate_id_fk");
        });
        ...
        modelBuilder.Entity<Emploee>(entity =>
        {
            ...
            entity.HasOne(d => d.Affiliate).WithMany(p => p.Emploees)
                .HasForeignKey(d => d.AffiliateId)
                .HasConstraintName("emploees_affiliate_id_fk");
        });
        ...
        modelBuilder.Entity<Journal>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Transnumber, e.CompanyId }, "ix_journal_combo");

            entity.HasIndex(e => e.CompanyId, "ix_journal_company_id");

            entity.HasIndex(e => e.Transnumber, "ix_journal_transnumber");
            ...
            entity.Property(e => e.Receiptn).HasColumnName("receiptn");
            entity.Property(e => e.Transnumber).HasColumnName("transnumber");
        ...
        modelBuilder.Entity<Transaction>(entity =>
        {
            ...
            entity.HasOne(d => d.Affiliate).WithMany(p => p.Transactions)
                .HasForeignKey(d => d.AffiliateId)
                .HasConstraintName("transactions_affiliate_id_fk");
